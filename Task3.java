...
public class Task3{
    ...
    public static void newTransaction(Customer cus) throws InterruptedException {
        String answer;
        try {
    ...
    public static void useCredit(Customer cus) throws InterruptedException {
        ...
        if (intMonth == 1) {
            ...
            double tempInterest = 1.4;
            System.out.printf("\nYour backpayment period will be Option " + intMonth
                    + " and your total backpayment will be: %.2f\n",tempCredit * (1 + intMonth * tempInterest / 100));
